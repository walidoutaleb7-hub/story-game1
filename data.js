    ...
    chapters: [
...

        {
            ...
            scenes: [
                ...
                {
                    id: "c6_previous",
                    title: "الملاحظة الأخيرة",
                    location: "الأرشيف",

                    text:
                        "في الصفحة الأخيرة وجد آدم جملة مكتوبة بخط اليد: " +
                        "\"إذا وصل آدم إلى هذه الصفحة، فهذا يعني أن النسخة الأولى فشلت.\" " +
                        "وتحتها مباشرة: \"لا تدع النسخة الثانية تتذكر كل شيء.\"",

                    choices: [
                        {
                            id: "c6_previous_continue",
                            text: "تابع.",
                            next: "c7_memory"
                        }
                    ]
...

                {
                    ...
                    text:
                        "شغّل آدم إحدى الشاشات. " +
                        "ظهرت لقطات قديمة للمنشأة. " +
                        "رأى نفسه يدخل الغرفة البيضاء... ثم رأى ليان تدخل خلفه. " +
                        "لكن التاريخ الظاهر على التسجيل يعود إلى سنوات مضت.",

                    choices: [
                        {
                            id: "c6_cameras_continue",
                            text: "شاهد التسجيل حتى النهاية.",
                            next: "c7_memory",
            ...
            scenes: [

                {
                    ...
                    text:
                        "أغمض آدم عينيه. " +
                        "عاد المشهد مرة أخرى. " +
                        "الغرفة البيضاء. الضوء القوي. الأجهزة. " +
                        "وهذه المرة استطاع أن يرى الشخص الواقف خلف الزجاج. " +
                        "كان آدم نفسه.",
                ...
                {
                    id: "c7_memory2",
                    title: "اللحظة المنسية",
                    location: "ذاكرة آدم",

                    text:
                        "تغير المشهد. " +
                        "كان آدم يجلس أمام جهاز تسجيل، وليان تقف بجانبه. " +
                        "قال آدم في الذكرى: \"إذا حدث شيء، لا تسمحي لهم بإعادة التجربة.\" " +
                        "ثم التفت إليها وأضاف: \"حتى لو طلبت منك ذلك بنفسي.\"",
...

                {
                    ...
                    text:
                        "نظر آدم إلى ليان وقال: \"كنتِ تعرفين كل شيء.\" " +
                        "خفضت ليان عينيها. " +
                        "ثم قالت: \"كنت أعرف أنك ستعود... لكنني لم أكن أعرف أي نسخة منك ستعود.\"",

                    choices: [
                        {
                            id: "c7_fear",
                            text: "اطلب منها أن تواصل الحديث.",
                            next: "c7_fear",
...

                {
                    ...
                    text:
                        "قالت ليان: \"في الليلة الأخيرة، حدث خطأ. " +
                        "لم تختفِ ذاكرتك وحدها. اختفت ذاكرة الجميع المتعلقة بك. " +
                        "حتى أنا... اضطررت إلى تدوين كل شيء حتى لا أنسى.\" " +
                        "ثم أضافت: \"لكن هناك شيئًا واحدًا لم أكتبه.\"",
...

                {
                    ...
                    text:
                        "فتحت ليان درجًا مخفيًا. " +
                        "في داخله سجل صغير لا يحمل أي رقم. " +
                        "قالت: \"هذا السجل لم يقرأه أحد غيري.\" " +
                        "فتحه آدم، فوجد ثلاث كلمات فقط: " +
                        "\"لم يكن آدم الأول.\"",

                    choices: [
                        {
                            id: "c7_accident",
                            text: "اقرأ ما وراء الكلمات.",
                            next: "c7_accident"
                        }
                    ]
                },
                ...
                {
                    id: "c7_accident",
                    title: "الحقيقة الناقصة",
                    location: "الأرشيف",

                    text:
                        "تحت العبارة كان هناك رسم لثلاث دوائر متصلة. " +
                        "الأولى تحمل الرقم 0317، والثانية تحمل حرف A، والثالثة بلا رقم. " +
                        "وعندما قلب آدم الصفحة، سقطت منها قطعة صغيرة تحمل صورته.",

                    choices: [
                        {
                            id: "c8_city",
                            text: "اتبع الإشارة الموجودة خلف الصورة.",
                            next: "c8_city",

                            effects: {
                                addItems: ["memoryFragment"],
                                setFlags: {
                                    sawMemory3: true
                                }
                            }
...

        {
            ...
            scenes: [

                {
                    ...
                    text:
                        "خرج آدم وليان من المنشأة مع أول ضوء للفجر. " +
                        "لكن المدينة كانت خالية تمامًا. " +
                        "لا سيارات، لا أصوات، ولا أثر للحياة. " +
                        "وعلى كل شاشة إلكترونية في الشوارع ظهر الرقم نفسه: 03:17.",

                    choices: [
                        {
                            id: "c8_answer",
                            text: "ابحث عن مصدر الإشارة.",
                            next: "c8_answer"
                        }
                    ]
                },
...

                {
                    ...
                    text:
                        "قادهم الرقم إلى مبنى مهجور. " +
                        "في الداخل وجد آدم شاشة تعمل رغم انقطاع الكهرباء. " +
                        "ظهرت عليها رسالة: \"إذا وصلت إلى هنا، فقد بدأت تتذكر أكثر مما ينبغي.\"",
...

                {
                    ...
                    text:
                        "في المرآب وجد آدم السيارة السوداء نفسها التي رآها في بداية رحلته. " +
                        "كانت أبوابها مفتوحة. " +
                        "وعلى المقعد الأمامي وُجد ظرف يحمل اسمه.",
...

                {
                    ...
                    text:
                        "كانت الرسالة قصيرة: " +
                        "\"آدم، عندما تقرأ هذا، لا تبحث عن الشخص الذي فعل بك ذلك. " +
                        "ابحث عن السبب الذي جعلك توافق عليه.\" " +
                        "وفي أسفل الصفحة توقيع واحد: آدم.",

                    choices: [
                        {
                            id: "c9_phone",
                            text: "شغّل الهاتف المكسور.",
                            next: "c9_phone"
                        }
                    ]
                }
...

        {
            ...
            scenes: [
                ...
                {
                    id: "c9_phone",
                    title: "المكالمة الأخيرة",
                    location: "المرآب",

                    text:
                        "أضاء الهاتف من تلقاء نفسه. " +
                        "ظهر رقم 0317 مرة أخرى. " +
                        "لكن هذه المرة لم يرن الهاتف. " +
                        "وصل تسجيل صوتي فقط.",

                    choices: [
                        {
                            id: "c9_accident",
                            text: "استمع إلى التسجيل.",
                            next: "c9_accident",
...

                {
                    ...
                    text:
                        "جاء صوت آدم من الهاتف: " +
                        "\"كنت أعرف أنني سأفقد ذاكرتي. " +
                        "أنا من طلب منهم أن يفعلوا ذلك. " +
                        "لكنني لم أفعلها هربًا من الحقيقة... بل لحمايتها.\"",
...

                {
                    ...
                    text:
                        "قالت ليان: \"كنت أريد أن أخبرك منذ البداية.\" " +
                        "ثم أضافت: \"لكن لو تذكرت كل شيء دفعة واحدة، لعرفوا أنك عدت.\" " +
                        "سألها آدم: \"من هم؟\" " +
                        "أجابته: \"الأشخاص الذين لم يغادروا المنشأة قط.\"",

                    choices: [
                        {
                            id: "c9_agreement",
                            text: "اتفق مع ليان على العودة.",
                            next: "c9_agreement",
...

                {
                    id: "c9_agreement",
                    title: "العودة",
                    location: "الطريق إلى المنشأة",

                    text:
                        "عاد آدم وليان إلى الطريق. " +
                        "هذه المرة لم يكن آدم يبحث عن إجابة فقط. " +
                        "كان يبحث عن الشخص الذي ترك له كل هذه الرسائل. " +
                        "وعندما وصلا إلى البوابة، انفتحت وحدها.",

                    choices: [
                        {
                            id: "c10_truth",
                            text: "ادخل المنشأة للمرة الأخيرة.",
                            next: "c10_truth"
                        }
                    ]
                }
...

        {
            ...
            scenes: [

                {
                    ...
                    text:
                        "دخل آدم الغرفة الأخيرة. " +
                        "لم تكن تحتوي على أجهزة كثيرة. " +
                        "كانت تحتوي على كرسي واحد، وشاشة، ومرآة كبيرة. " +
                        "ظهرت على الشاشة عبارة: \"مرحبًا بعودتك يا آدم.\"",
...

                {
                    id: "c10_screen",
                    title: "التسجيل الأول",
                    location: "الغرفة الأخيرة",

                    text:
                        "ظهر تسجيل قديم لآدم. " +
                        "قال: \"إذا وصلت إلى هنا، فقد نجحت الخطة.\" " +
                        "ثم صمت قليلًا وأضاف: \"أنا لم أكن أحاول نسيان الماضي. كنت أحاول منعه من الوصول إليك.\"",

                    choices: [
                        {
                            id: "c10_memory",
                            text: "شاهد التسجيل كاملًا.",
                            next: "c10_memory"
                        }
                    ]
                },
...

                {
                    ...
                    text:
                        "نظر آدم إلى المرآة. " +
                        "كان انعكاسه طبيعيًا... حتى ابتسم. " +
                        "لكن آدم لم يكن يبتسم. " +
                        "ثم ظهر على المرآة رقم واحد: 1.",

                    choices: [
                        {
                            id: "c10_memory",
                            text: "لا تبتعد عن المرآة.",
                            next: "c10_memory"
                        }
                    ]
                },
...

                {
                    ...
                    text:
                        "تذكر آدم أخيرًا. " +
                        "قبل سنوات، اكتشف أن المنشأة لا تمحو الذكريات فقط. " +
                        "كانت تحفظ نسخًا منها. " +
                        "وكل نسخة كانت تُستخدم لصنع شخص قادر على حمل جزء من ذاكرة الأصل.",

                    choices: [
                        {
                            id: "c10_truth2",
                            text: "استعد بقية الذاكرة.",
                            next: "c10_truth2",
...

                {
                    ...
                    text:
                        ...
                        "أجاب الصوت من مكبر الغرفة: \"وأخيرًا تذكرت.\" " +
                        "ظهرت على الشاشة عبارة: \"النسخة الأولى ما زالت هنا.\"",
...

        {
            ...
            scenes: [

                {
                    id: "c11_choice",
                    title: "الباب الأخير",
                    location: "القسم المحظور",

                    text:
                        "انفتح الباب ببطء. " +
                        "خلفه كانت هناك غرفة واسعة تتوسطها منصة زجاجية. " +
                        "داخلها شخص نائم. " +
                        "اقترب آدم، ثم توقف. " +
                        "كان الوجه هو وجهه.",
                    ...
                    choices: [
                        {
                            id: "c11_accept",
                            text: "اقترب من المنصة.",
                            next: "c11_accept"
                        },

                        {
                            id: "c11_refuse",
                            text: "ابتعد عنها وابحث عن طريقة لإيقاف النظام.",
                            next: "c11_refuse"
                        }
                    ]
                },
...

                {
                    ...
                    text:
                        "اقترب آدم من الزجاج. " +
                        "فتح الشخص عينيه. " +
                        "لم يتحدث، لكن الشاشة بجانبه أظهرت رسالة: " +
                        "\"أنت الذاكرة التي فقدتها... وأنا الشخص الذي فقدته.\"",

                    choices: [
                        {
                            id: "c11_merge",
                            text: "استمع إلى الرسالة حتى النهاية.",
                            next: "c11_merge",
...

                {
                    ...
                    text:
                        "فهم آدم الحقيقة كاملة. " +
                        "لم تكن هناك مؤامرة لصنع نسخة منه. " +
                        "كان هو من بدأ التجربة، ثم حاول إيقافها عندما أدرك نتائجها. " +
                        "ولكي يمنع نفسه من العودة، طلب أن تُمحى ذاكرته. " +
                        "لكن التجربة تركت جزءًا منه هنا.",

                    choices: [
                        {
                            id: "c12_final",
                            text: "أنه التجربة بنفسك.",
                            next: "c12_final"
                        }
                    ]
                },
...

                {
                    ...
                    text:
                        "ابتعد آدم عن المنصة. " +
                        "قال: \"لن أكرر ما حدث.\" " +
                        "بدأ النظام بإصدار إنذارات متتابعة. " +
                        "قالت ليان: \"إذا أوقفت النظام الآن، فقد تختفي كل السجلات.\" " +
                        "نظر آدم إليها. " +
                        "كان عليه أن يختار بين الحقيقة والنجاة.",
...

        {
            ...
            scenes: [

                {
                    ...
                    text:
                        "وقف آدم أمام لوحة التحكم. " +
                        "خلفه كانت ليان تنتظر قراره. " +
                        "وعلى الشاشة ظهر سؤال واحد: " +
                        "\"هل تريد أن تعرف من كنت... أم من أصبحت؟\"",

                    choices: [

                        {
                            id: "c12_truth",
                            text: "أريد الحقيقة كاملة.",
                            next: "ending_true",
                        ...
                        {
                            id: "c12_escape",
                            text: "يكفيني ما عرفته. أريد الخروج.",
                            next: "ending_escape"
                        },
...

                {
                    ...
                    text:
                        "ضغط آدم الزر الأخير. " +
                        "اختفت جميع الأرقام من الشاشات. " +
                        "ثم ظهرت رسالة لم تكن موجودة في أي ملف: " +
                        "\"أحسنت. لقد وصلت إلى الذكرى التي لم نكن نريدك أن تصل إليها.\" " +
                        "نظر آدم إلى ليان. " +
                        "وفهم أخيرًا أن الرحلة كلها لم تكن لاستعادة الماضي... " +
                        "بل لاختيار المستقبل.",
                ...
                {
                    id: "ending_escape",
                    title: "النهاية: الطريق المفتوح",
                    location: "خارج المنشأة",

                    text:
                        "غادر آدم المنشأة قبل أن يعرف كل شيء. " +
                        "كانت الشمس قد بدأت بالظهور. " +
                        "للمرة الأولى منذ استيقاظه، شعر أن الطريق أمامه حقيقي. " +
                        "لكنه عندما نظر إلى هاتفه، وجد رسالة جديدة: " +
                        "\"لم تنتهِ القصة يا آدم.\"",
...

                {
                    ...
                    text:
                        "أوقف آدم النظام. " +
                        "انطفأت الشاشات واحدة تلو الأخرى. " +
                        "اختفى الرقم 0317 للمرة الأولى. " +
                        "لم يعرف آدم إن كان قد أنهى التجربة أم محا آخر دليل عليها. " +
                        "لكن شيئًا واحدًا كان واضحًا: لن تعود المنشأة إلى العمل.",
                ...
                {
                    id: "ending_secret",
                    title: "النهاية السرية",
                    location: "الأرشيف",

                    text:
                        "في مكان لا يظهر على أي خريطة، بقي ملف واحد مضاء. " +
                        "كان يحمل اسمًا مختلفًا عن آدم. " +
                        "اقتربت ليان من الشاشة وقالت: \"إذن لم يكن هو البداية.\" " +
                        "ظهر رقم جديد: 0418.",

                    choices: [
                        {
                            id: "secret_end",
                            text: "افتح الملف الجديد.",
                            next: "END_SECRET"
                        }
                    ]
                }
